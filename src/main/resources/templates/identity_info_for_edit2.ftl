...
<div>
    <table style="font-size: 14px;" class="table table-bordered table-hover table-condensed">
        ...
        <tr>
            <td colspan="4">申请人曾用名：
                <input data-id="${person.id?c}"   data-name="person.formerName"
                       class="edit input-large" style="height: 25px;"
        ...
        <tr>
            <td colspan="12">申请人实际办公地址：
                <input data-id="${other.id?c}" data-name="other.applyOfficeAddress"
                       class="edit input-large" style="height: 25px;"
                       value="${other.applyOfficeAddress}">
            </td>
        </tr>

        <tr>
            <td colspan="12">实际用工单位所属行业：
                <input data-id="${other.id?c}" data-name="other.industry"
                       class="edit input-large" style="height: 25px;"
                       value="${other.industry}">
            </td>
        </tr>
        <tr>
            <td colspan="12">申请人现工作岗位：
                <input data-id="${other.id?c}" data-name="other.jobTitle"
                       class="edit input-large" style="height: 25px;"
                       value="${other.jobTitle}">
            </td>
        </tr>
        <tr>
            <td colspan="12">具体工作内容：
                <input data-id="${other.id?c}" data-name="other.jobContent"
                       class="edit input-large" style="height: 25px;"
                       value="${other.jobContent}">
            </td>
        </tr>
