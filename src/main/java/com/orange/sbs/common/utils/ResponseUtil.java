...
public class ResponseUtil {
    ...
    public static void writeJson(HttpServletResponse response, Integer code, String message, String targetUrl)
            throws IOException {
    ...
    public static Result error(BindingResult result) {
        ...
        if (result.hasFieldErrors()) {
            msg = result.getFieldErrors().get(0).getField() + ":" + result.getFieldError().getDefaultMessage();
        }
        return new Result(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, msg);
    }
