...
import com.orange.sbs.module.security.*;
import com.orange.sbs.module.security.service.SecurityService;
...
public class WebSecurityConfiger extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        super.configure(web);
        web.ignoring()
                .antMatchers("/upload/**", "/api/token/login", "/api/token/refresh", "/api/noneAuth/**", "/static/**");
    }
