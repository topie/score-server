...
public class MybatisConfigurer {
    ...
    public static SqlSessionFactory sqlSessionFactoryBean(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        factory.setTypeAliasesPackage("com.orange.sbs.database.*.model");
    ...
    public static MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.orange.sbs.database.*.dao");

        //配置通用Mapper，详情请查阅官方文档
        Properties properties = new Properties();
        properties.setProperty("mappers", "com.orange.sbs.common.core.Mapper");
