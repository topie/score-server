...
import static com.orange.sbs.ProjectConstant.*;

/**
 * 代码生成器，根据数据表名称生成对应的Model、Mapper、IService、Controller简化开发。
 */
public class CodeGenerator {

    //JDBC配置，请修改为你项目的实际配置

    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/sp_boot";
    ...
    private static final String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath(SERVICE_IMPL_PACKAGE,
            MODULE);//生成的Service实现存放路径

    private static final String PACKAGE_PATH_CONTROLLER = packageConvertPath(CONTROLLER_PACKAGE,
            MODULE);//生成的Controller存放路径

    private static final String AUTHOR = "chenJz1012";//@author

    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
        genCodeByCustomModelName("d_example", "Example", "id");
    }
    ...
    public static void genModelAndMapper(String tableName, String modelName, String idField) {
        ...
        javaModelGeneratorConfiguration.setTargetPackage(MODEL_PACKAGE.replaceAll("\\*", MODULE));
        context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

        SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration = new SqlMapGeneratorConfiguration();
        sqlMapGeneratorConfiguration.setTargetProject(PROJECT_PATH + RESOURCES_PATH);
        sqlMapGeneratorConfiguration.setTargetPackage("mapper/" + MODULE);
        context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);

        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
        javaClientGeneratorConfiguration.setTargetProject(PROJECT_PATH + JAVA_PATH);
        javaClientGeneratorConfiguration.setTargetPackage(MAPPER_PACKAGE.replaceAll("\\*", MODULE));
        ...
        tableConfiguration.setGeneratedKey(new GeneratedKey(idField, "Mysql", true, null));
    ...
    public static void genScript(String tableName, String modelName, String idField) {
        try {
            freemarker.template.Configuration cfg = getConfiguration();
    ...
    private static String packageConvertPath(String packageName, String module) {
        packageName = packageName.replaceAll("\\*", module);
        return String.format("/%s/", packageName.contains(".") ? packageName.replaceAll("\\.", "/") : packageName);
    }
