...
public class ScoreRecordController {
    ...
    @GetMapping(value = "/material/receiving")
    @ResponseBody
    ...
    @GetMapping(value = "/material/received")
    @ResponseBody
    ...
    @GetMapping("/material/detailAll")
    public Result detailAll() throws FileNotFoundException {
